...
export default function WishlistCard({ name, image, price, className, onClick }: Props) {
    return (
        <div className={`flex flex-col items-center justify-center gap-2 ${className}`}>
            <div className="w-full border-1 rounded-xl border-(--brand-3)"  onClick={onClick}>
            ...
            <div className="flex flex-row justify-center gap-2 w-full">
                ...
                <SecButton text="Share This Card" />
            </div>
        </div>
    )
}